...
namespace defused_the_bomb
{
    public abstract class Malette
    {
        ...
        virtual public void ContentLoad(ContentManager Content)
        {
            ...
            GUIarrowRight = new GuiButton("repeat", false, 100, 7, new Vector2(792, 334), Content);
            GUIarrowLeft = new GuiButton("repeat", false, 100, 7, new Vector2(116, 334), Content);
            GUIarrowUp = new GuiButton("repeat", true, 100, 7, new Vector2(438, 139), Content);
            GUIarrowDown = new GuiButton("repeat", true, 100, 7, new Vector2(438, 556), Content);
